...
public class GunScriptableObject : ScriptableObject
{
    ...
    private IEnumerator PlayTrail(Vector3 StartPoint, Vector3 EndPoint, RaycastHit Hit)
    {
        ...
        float remainingDistancce = distance;
        while (remainingDistancce > 0)
        {
            instance.transform.position = Vector3.Lerp(StartPoint, EndPoint, Mathf.Clamp01(1  - (remainingDistancce / distance)));
            remainingDistancce -= TrailConfig.SimulationSpeed * Time.deltaTime;
